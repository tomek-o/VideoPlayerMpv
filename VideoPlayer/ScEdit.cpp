...
void TScEdit::setCppStyle(int colorSchemeId)
{
	const char* szKeywords1 = "true false null";
	...
	{
	case SC_EDIT_JSON_COLOR_DARK:
		SendEditor(SCI_STYLESETBACK, STYLE_DEFAULT, RGB(0, 0, 0));
		SendEditor(SCI_STYLESETFORE, STYLE_DEFAULT, RGB(255, 255, 255));
		SendEditor(SCI_STYLECLEARALL);

		SendEditor(SCI_STYLESETBACK, SCE_C_DEFAULT, RGB(0,0,0));
		SendEditor(SCI_STYLESETFORE, SCE_C_DEFAULT, 0x00E0E0E0);

		SendEditor(SCI_STYLESETFORE, SCE_C_WORD, 0x00FF0000);
		SendEditor(SCI_STYLESETFORE, SCE_C_WORD2, 0x00A040A0);
		SendEditor(SCI_STYLESETBOLD, SCE_C_WORD2, TRUE);
		SendEditor(SCI_STYLESETFORE, SCE_C_STRING, 0x004545A3);
		SendEditor(SCI_STYLESETFORE, SCE_C_CHARACTER, 0x001515A3);
		SendEditor(SCI_STYLESETFORE, SCE_C_PREPROCESSOR, 0x00808080);
		SendEditor(SCI_STYLESETFORE, SCE_C_COMMENT, 0x0040A040);
		SendEditor(SCI_STYLESETFORE, SCE_C_COMMENTLINE, 0x0040A040);
		SendEditor(SCI_STYLESETFORE, SCE_C_COMMENTDOC, 0x0040A040);


		SendEditor(SCI_STYLESETBACK, STYLE_BRACELIGHT, 0x00777777);
		SendEditor(SCI_STYLESETFORE, STYLE_BRACELIGHT, 0x00FFFFFF);
		SendEditor(SCI_STYLESETBACK, STYLE_BRACEBAD, 0x002020FF);

		SendEditor(SCI_SETCARETLINEVISIBLE, TRUE);
		SendEditor(SCI_SETCARETLINEBACK, 0x00202020);	// background for current (edited) line)
		SendEditor(SCI_SETCARETFORE, 0x00F0F0F0);

		SendEditor(SCI_STYLESETFORE, SCE_C_WORD, RGB(200,200,200));

		SendEditor(SCI_STYLESETBACK, STYLE_LINENUMBER, RGB(0, 0, 0));
		break;
	default:
		...
		SendEditor(SCI_STYLESETBACK, SCE_C_DEFAULT, RGB(255, 255, 255));
		SendEditor(SCI_STYLESETFORE, SCE_C_DEFAULT, 0x00000000);
		...
		SendEditor(SCI_SETCARETLINEVISIBLE, TRUE);
		SendEditor(SCI_SETCARETLINEBACK, 0x00b0ffff);
		SendEditor(SCI_SETCARETFORE, 0x00000000);

		SendEditor(SCI_STYLESETFORE, SCE_C_WORD, RGB(20,20,20));		
		break;
	}
}

void TScEdit::setJsonStyle(int colorSchemeId)
{
	//const char* szKeywords1 = "true false null";
	...
	case SC_EDIT_JSON_COLOR_DARK:
		...
		SendEditor(SCI_STYLESETBACK, SCE_JSON_DEFAULT, RGB(0,0,0));

		SendEditor(SCI_STYLESETFORE, SCE_JSON_DEFAULT, 0x00808080);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_NUMBER, 0x00FF3030);	// blue
		SendEditor(SCI_STYLESETFORE, SCE_JSON_STRING, 0x00FF00B0);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_STRINGEOL, 0x00FF00B0);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_PROPERTYNAME, 0x000000B0);	// maroon
		SendEditor(SCI_STYLESETFORE, SCE_JSON_ESCAPESEQUENCE, 0x00FF2020);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_LINECOMMENT, 0x0020FF20);	// green
		SendEditor(SCI_STYLESETFORE, SCE_JSON_BLOCKCOMMENT, 0x0020FF20);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_OPERATOR, 0x00FF8080);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_URI, 0x00FF2020);
		SendEditor(SCI_STYLESETUNDERLINE, SCE_JSON_URI, 0x00FF2020);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_COMPACTIRI, 0x00B0B0B0);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_KEYWORD, 0x00FF2020);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_LDKEYWORD, 0x00FF2020);
		SendEditor(SCI_STYLESETFORE, SCE_JSON_ERROR, 0x002020FF);
		...
		//SendEditor(SCI_STYLESETFORE, SCE_JSON_WORD, RGB(200,200,200));
		SendEditor(SCI_STYLESETBACK, STYLE_LINENUMBER, RGB(0, 0, 0));
		break;
	default:
		SendEditor(SCI_STYLESETBACK, STYLE_DEFAULT, RGB(255, 255, 255));
		...
		SendEditor(SCI_STYLESETBACK, SCE_JSON_DEFAULT, RGB(255, 255, 255));
		...
		//SendEditor(SCI_STYLESETFORE, SCE_JSON_WORD1, RGB(20,20,20));
		break;
	}
}
...
void TScEdit::setStyle(enum ScEditStyle style, int colorSchemeId)
{
	...
	{
		setCppStyle(colorSchemeId);
		//setCppStyle(colorSchemeId);
	}
	else if (style == SC_STYLE_JSON)
	{
		setJsonStyle(colorSchemeId);
		//setJsonStyle(colorSchemeId);
	}
	else
	{
